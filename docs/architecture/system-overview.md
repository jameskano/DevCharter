...
separate writer-capable application subpath, and the Codex adapter. Completed SPEC-0001E adds release
qualification, composable installed-CLI journeys, deterministic validation composition, production
tarballs, cross-platform CI evidence, and the separately approved Habit Compass preservation pilot.
