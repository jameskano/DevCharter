...
- `ready/SPEC-0002E-plan-mode-proposal-refinement.md` — approved refinement for native Plan mode as
...
SPEC-0002A through SPEC-0002D are ordered implementation specifications and are done. SPEC-0002E is
ready and depends on them. Move it to `active` before implementation; activate any other future work
only after its specification is approved and dependencies are complete, unless an independent
workstream is explicitly approved.
